...
func TestHappyPath(t *testing.T) {
	...
	*/
	...
	// 'mantis plan' comment should trigger terraform execution
	impactedProjects, requestedProject, prNumber, err = dg_github.ProcessGitHubEvent(ghEvent, diggerConfig, &githubPrService)
	assert.NoError(t, err)
	...
	// 'mantis apply' comment should trigger terraform execution and unlock the project
	impactedProjects, requestedProject, prNumber, err = dg_github.ProcessGitHubEvent(ghEvent, diggerConfig, &githubPrService)
	assert.NoError(t, err)
